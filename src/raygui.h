...
int GuiGroupBox(Rectangle bounds, const char *text)
{
    ...
    // Draw control
    //--------------------------------------------------------------------
    int borderProp = (state == STATE_DISABLED)? (int)BORDER_COLOR_DISABLED : (int)LINE_COLOR;
    GuiDrawRectangle(RAYGUI_CLITERAL(Rectangle){ bounds.x, bounds.y, RAYGUI_GROUPBOX_LINE_THICK, bounds.height }, 0, BLANK, GetColor(GuiGetStyle(DEFAULT, borderProp)));
    GuiDrawRectangle(RAYGUI_CLITERAL(Rectangle){ bounds.x, bounds.y + bounds.height - 1, bounds.width, RAYGUI_GROUPBOX_LINE_THICK }, 0, BLANK, GetColor(GuiGetStyle(DEFAULT, borderProp)));
    GuiDrawRectangle(RAYGUI_CLITERAL(Rectangle){ bounds.x + bounds.width - 1, bounds.y, RAYGUI_GROUPBOX_LINE_THICK, bounds.height }, 0, BLANK, GetColor(GuiGetStyle(DEFAULT, borderProp)));
...
int GuiLine(Rectangle bounds, const char *text)
{
    ...
    int lineProp = (state == STATE_DISABLED)? (int)BORDER_COLOR_DISABLED : (int)LINE_COLOR;
    Color color = GetColor(GuiGetStyle(DEFAULT, lineProp));
...
int GuiPanel(Rectangle bounds, const char *text)
{
    ...
    int panelBorderProp = (state == STATE_DISABLED)? (int)BORDER_COLOR_DISABLED: (int)LINE_COLOR;
    int panelBgProp = (state == STATE_DISABLED)? (int)BASE_COLOR_DISABLED : (int)BACKGROUND_COLOR;
    GuiDrawRectangle(bounds, RAYGUI_PANEL_BORDER_WIDTH, GetColor(GuiGetStyle(DEFAULT, panelBorderProp)),
                     GetColor(GuiGetStyle(DEFAULT, panelBgProp)));
    //--------------------------------------------------------------------
